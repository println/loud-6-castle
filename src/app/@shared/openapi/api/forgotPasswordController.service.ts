...
export class ForgotPasswordControllerService {
    ...
    public changePassword(body: ForgotPasswordDto, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<Unit>>;
    public changePassword(body: ForgotPasswordDto, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<Unit>>;
    public changePassword(body: ForgotPasswordDto, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
    ...
    public forgot(body: ForgotPasswordEmailDto, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<Unit>>;
    public forgot(body: ForgotPasswordEmailDto, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<Unit>>;
