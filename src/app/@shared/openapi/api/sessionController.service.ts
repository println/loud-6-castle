...
export class SessionControllerService {
     ...
     */
    public getAll21(pageable: Pageable, observe?: 'body', reportProgress?: boolean): Observable<PageSession>;
    public getAll21(pageable: Pageable, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<PageSession>>;
    public getAll21(pageable: Pageable, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<PageSession>>;
    public getAll21(pageable: Pageable, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {

        if (pageable === null || pageable === undefined) {
            throw new Error('Required parameter pageable was null or undefined when calling getAll21.');
        }
    ...
    public getById11(id: string, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.request<Session>('get',`${this.basePath}/api/v1/session/${encodeURIComponent(String(id))}`,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
                observe: observe,
